...
class DefaultViewManager {
	constructor(options) {
		...
		this.viewSettings = {
			...
			width: 0,
			height: 0,
			viewWidth: this.settings.viewWidth,
			viewHeight: this.settings.viewHeight,
			forceEvenPages: true,
	...
	render(element, size) {
		...
		this.viewSettings.width = this.settings.viewWidth || this._stageSize.width;
		this.viewSettings.height = this.settings.viewHeight || this._stageSize.height;
	...
	updateLayout() {
		...
		if (!this.isPaginated) {
			this.layout.calculate(this.settings.viewWidth || this._stageSize.width, this.settings.viewHeight || this._stageSize.height);
		} else {
		...
		this.viewSettings.width = this.settings.viewWidth || this.layout.width;
		this.viewSettings.height = this.settings.viewHeight || this.layout.height;
